...
**Node 1:**
```bash
java -cp target/Project1.jar org.example.Main interface=eth2 babel.port=10101
```

**Node 2:**
```bash
java -cp target/Project1.jar org.example.Main interface=eth2 babel.port=10102 contact=<YOUR-IPV4>:<PORT-OF-NODE1>
```
